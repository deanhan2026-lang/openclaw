...
| `qa-smoke-ci-shard`                | Four bounded, channel-compatible QA Smoke shards: Matrix plus three shards for the current Crabline default channel                                                                                | Node-relevant changes                               |
